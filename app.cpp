    ...
    */
    ...
    // {
    //     // TODO
    //     // std::ifstream inputFile("power_sim_input.json");
    //     std::ifstream inputFile("simple_sim_input.txt");

    //     if (!inputFile.is_open())
    //     {
    //         SPDLOG_LOGGER_ERROR(Logger::instance(), "Unable to open input file: power_sim_input.json");
    //         return;
    //     }
    ...
    //     // TODO
    //     // std::string simulator = "power_sim";
    //     std::string simulator = "simple_sim";
    ...
    //         http::read(stream, buffer, res, ec2);
    //         if (ec2 == http::error::end_of_stream)
    //         {
    //             SPDLOG_LOGGER_WARN(Logger::instance(), "Server closed connection after response");
    //         }
    //         else if (ec2)
    //         {
    ...
    //         {
    //             SPDLOG_LOGGER_WARN(Logger::instance(), "TCP stream closed after request {}", i);
    //         }
